...
export const trainings: Training[] = [
  {
    ...
    "status": "closed",
    "summary": "Construire des pipelines d'automatisation avec dashboards premium.",
    "description": "Un programme pour automatiser la collecte, la transformation et le reporting des données opérationnelles.",
    "outcomes": [
  ...
  },
  {
    ...
    "category": "Design & UX",
    "status": "closed",
    "summary": "Structurer l'expérience utilisateur avec une méthode orientée produit.",
    "description": "Un parcours pour bâtir des interfaces cohérentes, prioriser les besoins et piloter l'UX en équipe.",
    "outcomes": [
  ...
  },
  {
    ...
    "status": "closed",
    "summary": "Créer des applications mobiles élégantes avec un pipeline design-to-code.",
    "description": "Un programme axé sur la création de produits mobiles complets, du prototypage au lancement, avec des ateliers UX/UI.",
    "outcomes": [
  ...
  },
  {
    ...
    "status": "closed",
    "summary": "Maîtrisez Next.js, APIs et déploiements cloud avec un accompagnement orienté production.",
    "description": "Un parcours intensif pour créer des plateformes web robustes, sécurisées et performantes, avec un focus sur l'architecture et l'expérience utilisateur.",
    "outcomes": [
    ...
    "coverImage": "/Academy_images/Web Fullstack.jpg",
    "youtubeEmbed": "https://www.youtube.com/embed/2WTs8h3fQBs",
    "pdfProgram": "https://your-project.supabase.co/storage/v1/object/public/academy-media/web-fullstack-program.pdf"
  },
  {
    "slug": "nouvelle-formation-10",
  ...
  },
  {
    ...
    "status": "closed",
    "summary": "Optimiser la production agricole par les capteurs, l'analyse et l'automatisation.",
    "description": "Un programme en préparation pour développer des solutions de culture connectée, du pilotage à l'analyse des performances.",
    "outcomes": [
  ...
  },
  {
    ...
    "status": "closed",
    "summary": "Programme avancé autour des jumeaux numériques pour sites industriels.",
    "description": "Formation fermée temporairement, avec repositionnement en cours pour 2026.",
    "outcomes": [
    ...
    "coverImage": "/Academy_images/Digital Twin Industrie.webp",
    "youtubeEmbed": "https://www.youtube.com/embed/GtFyILZ1ICY",
    "pdfProgram": "/Academy PDF/Digital Twin Industrie.pdf"
  },
  {
    ...
    "status": "closed",
    "summary": "Construire des prototypes connectés et piloter des systèmes embarqués.",
    "description": "Un laboratoire appliqué pour créer des solutions IoT, intégrer capteurs, cloud et automatisation.",
    "outcomes": [
  ...
  },
  {
    ...
    "category": "Webinaire",
    "status": "soon",
    "summary": "Session interactive pour cadrer une roadmap IA produit et éviter les pièges courants.",
    "description": "Un webinaire stratégique pour identifier les bons cas d'usage IA, structurer une feuille de route et aligner les équipes produit & tech.",
    "outcomes": [
    ...
    "coverImage": "/Academy_images/Webinaire AI Product Roadmap.webp"
  },
  {
    ...
    "category": "Webinaire",
    "status": "soon",
    "summary": "Les bonnes pratiques de cybersécurité opérationnelle pour les équipes tech et business.",
    "description": "Un webinaire pratique pour sécuriser les accès, limiter les risques et mettre en place des routines simples.",
    "outcomes": [
    ...
    "coverImage": "/Academy_images/Webinaire Cyber Hygiene Essentials.jpg"
  }
];
