...
const copy: Record<SupportedLanguage, WebMobileCopy> = {
  fr: {
    hero: {
      ...
      title: "L'app que vos équipes",
      highlight: "attendaient depuis longtemps.",
      sub: "On la conçoit avec vous. On la livre en 3 mois. On la maintient dans la durée. Android, iOS ou web — vous choisissez.",
    ...
    catalogTitle: "Ce qu'on sait faire.",
    catalog: [
      { num: "01", title: "Gestion & opérations", tags: "Stocks · Équipes terrain · Production · Rapports" },
      { num: "02", title: "Commerce & vente", tags: "Boutique en ligne · Commandes · Paiement · Catalogue" },
      { num: "03", title: "Espace client", tags: "Portail dédié · Contrats · Factures · Suivi en temps réel" },
      { num: "04", title: "Sites & landing pages", tags: "Vitrine · Blog · Formulaires · Référencement" },
      { num: "05", title: "Tableaux de bord", tags: "Données live · Graphiques clairs · Exports automatiques" },
    ],
    processTitle: "Quatre étapes. Une app qui tourne.",
    process: [{ title: "On écoute" }, { title: "On dessine" }, { title: "On code" }, { title: "On met en ligne" }],
    cta: {
      eyebrow: "Pas de devis sans échange.",
      title: "Décrivez-nous l'app que vous imaginez.",
  ...
  en: {
    hero: {
      ...
      title: "The app your teams",
      highlight: "have been waiting for.",
      sub: "We design it with you. Deliver in 3 months. Maintain it long-term. Android, iOS or web — your call.",
    ...
    catalogTitle: "What we know how to build.",
    catalog: [
      { num: "01", title: "Management & operations", tags: "Inventory · Field teams · Production · Reports" },
      { num: "02", title: "Commerce & sales", tags: "Online store · Orders · Payment · Catalog" },
      { num: "03", title: "Customer portal", tags: "Dedicated space · Contracts · Invoices · Live tracking" },
      { num: "04", title: "Websites & landing pages", tags: "Brand · Blog · Forms · SEO" },
      { num: "05", title: "Dashboards", tags: "Live data · Clear charts · Automatic exports" },
    ],
    processTitle: "Four steps. One app that works.",
    process: [{ title: "We listen" }, { title: "We sketch" }, { title: "We code" }, { title: "We go live" }],
    cta: {
      eyebrow: "No quote without a conversation.",
      title: "Describe the app you're imagining.",
