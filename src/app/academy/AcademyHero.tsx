...
const heroCopy = {
  fr: {
    ...
    highlight: "Un projet réel. Un certificat.",
    sub: "Chaque session accueille 8 personnes au maximum. Vous travaillez sur un cas concret pendant la formation. Vous repartez avec un certificat Enov et des compétences directement applicables.",
    badges: ["8 participants max", "Projet à rendre", "Certificat Enov"],
  ...
  en: {
    kicker: "Enov Academy",
    title: "8 participants.",
    highlight: "A real project. A certificate.",
    sub: "Each session takes up to 8 people. You work on a real-world case throughout the training. You leave with an Enov certificate and directly applicable skills.",
    badges: ["Max 8 participants", "Project to complete", "Enov Certificate"],
    cta: "Register now",
