...
const heroCopy = {
  fr: {
    kicker: "Enov Academy",
    title: "La formation",
    highlight: "qui change vraiment quelque chose.",
    sub: "Pas de diapositives en boucle. Des projets réels, des groupes de 8 maximum, un vrai suivi. Vous repartez avec des compétences — et un certificat.",
  ...
  en: {
    kicker: "Enov Academy",
    title: "The training that",
    highlight: "actually changes something.",
    sub: "No looping slideshows. Real projects, groups of 8 max, real follow-up. You leave with skills — and a certificate.",
    badges: ["Max 8 participants", "Project to deliver", "Enov Certificate"],
    cta: "Register now",
